...
describe("filter types", (): void => {
  ...
  describe("FilterType", () => {
    ...
    describe("allowedComparisons option", () => {
      ...
      class TestAllowedComparisonsDto extends BaseType {
        ...
        @FilterableField({
          allowedComparisons: ["eq", "neq", "gt", "gte", "lt", "lte"],
        })
        numberField!: number;
      ...
      const TestGraphQLComparisonFilter: Class<Filter<TestDto>> = FilterType(
  ...
  describe("SubscriptionFilterType", () => {
    const TestGraphQLFilter: Class<Filter<TestDto>> =
      SubscriptionFilterType(TestDto);
