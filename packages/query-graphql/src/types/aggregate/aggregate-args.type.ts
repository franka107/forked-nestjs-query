import { Filter, Class } from "@franka107-nestjs-query/core";
...
export function AggregateArgsType<DTO>(
  DTOClass: Class<DTO>
): Class<AggregateArgsType<DTO>> {
  ...
  class AggregateArgs implements AggregateArgsType<DTO> {
    ...
    @Field(() => F, {
      nullable: true,
      description: "Filter to find records to aggregate on",
    })
    filter?: Filter<DTO>;
  }
