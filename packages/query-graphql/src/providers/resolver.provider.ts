...
export type CRUDAutoResolverOpts<
  DTO,
  C,
  U,
  R,
  PS extends PagingStrategies
> = CRUDResolverOpts<DTO, C, U, R, PS> & {
  DTOClass: Class<DTO>;
};

export type EntityCRUDAutoResolverOpts<
  DTO,
  Entity,
  C,
  U,
  R,
  PS extends PagingStrategies
> = CRUDAutoResolverOpts<DTO, C, U, R, PS> & {
  EntityClass: Class<Entity>;
};

export type AssemblerCRUDAutoResolverOpts<
  DTO,
  Assembler,
  C,
  U,
...
export type ServiceCRUDAutoResolverOpts<
  DTO,
  QueryService,
  C,
  U,
...
export type AutoResolverOpts<
  DTO,
  EntityServiceOrAssembler,
  C,
  U,
  R,
  PS extends PagingStrategies
...
export const isFederatedResolverOpts = <
  DTO,
  MaybeService,
  C,
  U,
...
>(
  ...
  "type" in opts && opts.type === "federated";

export const isAssemblerCRUDAutoResolverOpts = <
  DTO,
  MaybeAssembler,
  C,
  U,
...
export const isServiceCRUDAutoResolverOpts = <
  DTO,
  MaybeService,
  C,
  U,
...
>(
  ...
  "DTOClass" in opts && "ServiceClass" in opts;

const getResolverToken = <DTO>(DTOClass: Class<DTO>): string =>
  `${DTOClass.name}AutoResolver`;
const getFederatedResolverToken = <DTO>(DTOClass: Class<DTO>): string =>
  `${DTOClass.name}FederatedAutoResolver`;

function createFederatedResolver<DTO, Service>(
  resolverOpts: FederatedAutoResolverOpts<DTO, Service>
): Provider {
  ...
  class AutoResolver extends FederationResolver(DTOClass) {
    constructor(
      @Inject(resolverOpts.Service)
      readonly service: QueryService<DTO, unknown, unknown>,
  ...
  Object.defineProperty(AutoResolver, "name", {
    value: getFederatedResolverToken(DTOClass),
    writable: false,
  });
...
function createEntityAutoResolver<
  DTO,
  Entity,
  C,
  U,
...
>(
  ...
  class Service extends AssemblerQueryService<DTO, Entity, C, C, U, U> {
    constructor(service: QueryService<Entity, C, U>) {
      const assembler = AssemblerFactory.getAssembler<DTO, Entity, C, C, U, U>(
        DTOClass,
        EntityClass
      );
  ...
  // need to set class name so DI works properly
  Object.defineProperty(AutoResolver, "name", {
    value: getResolverToken(DTOClass),
    writable: false,
  });
  return AutoResolver;
}

function createAssemblerAutoResolver<
  DTO,
  Asmblr,
  C,
  U,
...
>(
  ...
  class AutoResolver extends CRUDResolver(DTOClass, resolverOpts) {
    constructor(
      @InjectAssemblerQueryService(
        AssemblerClass as unknown as Class<
          Assembler<DTO, unknown, C, unknown, U, unknown>
        >
      )
