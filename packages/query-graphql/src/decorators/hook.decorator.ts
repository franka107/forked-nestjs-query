...
const hookMetaDataKey = (hookType: HookTypes): string =>
  `nestjs-query:${hookType}`;
...
export const BeforeCreateOne = hookDecorator<BeforeCreateOneHook<any>>(
  HookTypes.BEFORE_CREATE_ONE
);
export const BeforeCreateMany = hookDecorator<BeforeCreateManyHook<any>>(
  HookTypes.BEFORE_CREATE_MANY
);
export const BeforeUpdateOne = hookDecorator<BeforeUpdateOneHook<any>>(
  HookTypes.BEFORE_UPDATE_ONE
);
export const BeforeUpdateMany = hookDecorator<BeforeUpdateManyHook<any, any>>(
  HookTypes.BEFORE_UPDATE_MANY
);
export const BeforeDeleteOne = hookDecorator<BeforeDeleteOneHook>(
  HookTypes.BEFORE_DELETE_ONE
);
export const BeforeDeleteMany = hookDecorator<BeforeDeleteManyHook<any>>(
  HookTypes.BEFORE_DELETE_MANY
);
export const BeforeQueryMany = hookDecorator<BeforeQueryManyHook<any>>(
  HookTypes.BEFORE_QUERY_MANY
);
export const BeforeFindOne = hookDecorator<BeforeFindOneHook>(
  HookTypes.BEFORE_FIND_ONE
);
