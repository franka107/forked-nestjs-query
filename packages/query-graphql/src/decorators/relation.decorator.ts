...
export type RelationDecoratorOpts<Relation> = Omit<
  ResolverRelation<Relation>,
  "DTO"
>;
export type RelationTypeFunc<Relation> = () => Class<Relation>;
export type RelationClassDecorator<DTO> = <Cls extends Class<DTO>>(
  DTOClass: Cls
) => Cls | void;
...
export const UnPagedRelation = relationDecorator(
  true,
  false,
  PagingStrategies.NONE
);
export const FilterableUnPagedRelation = relationDecorator(
  true,
  true,
  PagingStrategies.NONE
);

export const OffsetConnection = relationDecorator(
  true,
  false,
  PagingStrategies.OFFSET
);
export const FilterableOffsetConnection = relationDecorator(
  true,
  true,
  PagingStrategies.OFFSET
);

export const CursorConnection = relationDecorator(
  true,
  false,
  PagingStrategies.CURSOR
);
export const FilterableCursorConnection = relationDecorator(
  true,
  true,
  PagingStrategies.CURSOR
);
