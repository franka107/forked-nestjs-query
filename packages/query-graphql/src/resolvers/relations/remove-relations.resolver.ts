  ...
  <B extends Class<ServiceResolver<DTO, QueryService<DTO, unknown, unknown>>>>(
    ...
    class Mixin extends Base {
      ...
      async [`remove${pluralBaseName}From${dtoNames.baseName}`](
        ...
        return this.service.removeRelations(
          relationName,
          input.id,
          input.relationIds,
          modifyRelationsFilter
...
export const RemoveRelationsMixin =
  ...
  <B extends Class<ServiceResolver<DTO, QueryService<DTO, unknown, unknown>>>>(
    ...
    const WithMany = manyRelations.reduce(
      (RB, a) => RemoveManyRelationsMixin(DTOClass, a)(RB),
      Base
    );
    return oneRelations.reduce(
      (RB, a) => RemoveOneRelationMixin(DTOClass, a)(RB),
      WithMany
    );
  };
...
>(
  ...
  RemoveRelationsMixin(DTOClass, relations)(BaseServiceResolver);
