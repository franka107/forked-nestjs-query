import { CommonFieldComparisonBetweenType } from "@franka107-nestjs-query/core";
...
describe("SQLComparisonBuilder", (): void => {
  ...
  describe("neq comparisons", () => {
    it("should build neq sql fragment", (): void => {
      expect(
        createSQLComparisonBuilder().build("numberType", "neq", 1, "TestEntity")
      ).toEqual({
  ...
  describe("gt comparisons", () => {
    it("should build gt sql fragment", (): void => {
      expect(
        createSQLComparisonBuilder().build("numberType", "gt", 1, "TestEntity")
      ).toEqual({
        sql: "TestEntity.numberType > :param0",
        params: { param0: 1 },
      });
  ...
  describe("gte comparisons", () => {
    it("should build gte sql fragment", (): void => {
      expect(
        createSQLComparisonBuilder().build("numberType", "gte", 1, "TestEntity")
      ).toEqual({
        sql: "TestEntity.numberType >= :param0",
        params: { param0: 1 },
      });
  ...
  describe("lt comparisons", () => {
    it("should build gte sql fragment", (): void => {
      expect(
        createSQLComparisonBuilder().build("numberType", "lt", 1, "TestEntity")
      ).toEqual({
        sql: "TestEntity.numberType < :param0",
        params: { param0: 1 },
      });
  ...
  describe("lte comparisons", () => {
    it("should build gte sql fragment", (): void => {
      expect(
        createSQLComparisonBuilder().build("numberType", "lte", 1, "TestEntity")
      ).toEqual({
        sql: "TestEntity.numberType <= :param0",
        params: { param0: 1 },
      });
  ...
  describe("is comparisons", () => {
    it("should build is true", (): void => {
      expect(
        createSQLComparisonBuilder().build("boolType", "is", true, "TestEntity")
      ).toEqual({
    ...
    it("should build is null", (): void => {
      expect(
        createSQLComparisonBuilder().build("boolType", "is", null, "TestEntity")
      ).toEqual({
  ...
  describe("isNot comparisons", () => {
    ...
    it("should throw an error for values other than null true or false", () => {
      ...
      ).toThrow('unexpected isNot operator param "foo"');
    });
  });
  ...
  describe("in comparisons", () => {
    ...
    it("should throw an error for non-array", (): void => {
      expect(() =>
        createSQLComparisonBuilder().build("numberType", "in", 1, "TestEntity")
