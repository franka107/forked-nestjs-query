...
describe("FilterQueryBuilder", (): void => {
  ...
  describe("#select", () => {
    ...
    describe("with filter", () => {
      ...
      it("should call whereBuilder#build if there is a filter", () => {
        ...
        when(
          mockWhereBuilder.build(query.filter, deepEqual(new Map()))
        ).thenCall(() => ({
  ...
  describe("#update", () => {
    const expectUpdateOptions = (
      ...
      expect(getEntityQueryBuilder(whereBuilder).updateOptions(query)).toEqual(
        expectedUpdateOptions
      );
    };
  ...
  describe("#delete", () => {
    const expectDestroyOptions = (
      ...
      expect(getEntityQueryBuilder(whereBuilder).destroyOptions(query)).toEqual(
        expectedDestroyOptions
      );
    };
